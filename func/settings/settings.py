...
def show_desc(app):
    ...
    app_desc.pack()
    button1optiontext = open(f"/home/{username}/pi-ware/func/settings/options/{app}/button1", "r")
    button1option = button1optiontext.read()
    button2optiontext = open(f"/home/{username}/pi-ware/func/settings/options/{app}/button2", "r")
    button2option = button2optiontext.read()
    option1 = tk.Button(desc_win, text=f"{button1option}", font="Arial 11 bold", width=200, bg="darkblue", fg="white", command=install_app)
    option1.pack()
    option2 = tk.Button(desc_win, text=f"{button2option}", font="Arial 11 bold", width=200, bg="red", fg="white", command=uninstall_app)
    option2.pack()
